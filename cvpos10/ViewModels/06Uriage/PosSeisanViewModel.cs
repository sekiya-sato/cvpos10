...
public partial class PosSeisanViewModel : ObservableObject
{
    ...
    [ObservableProperty] public partial ObservableCollection<Tran02PosSeisan> PreviousSettlements { get; set; } = [];
    ...
    private async Task LoadAsync(CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var prev = await client.QueryListAsync<Tran02PosSeisan>(
    ...
    private async Task SaveSeisan(CancellationToken cancellationToken)
    {
        ...
        try
        {
            var response = await client.SaveSeisanAsync(new PosSaveSeisanRequest
            {
                ...
                KyakuSu = KyakuSu,
                Mai10000 = Mai10000, Mai5000 = Mai5000, Mai2000 = Mai2000, Mai1000 = Mai1000,
                Mai500 = Mai500, Mai100 = Mai100, Mai50 = Mai50, Mai10 = Mai10, Mai5 = Mai5, Mai1 = Mai1,
